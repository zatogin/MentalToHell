...
namespace MentalToHell.Controllers
{
    public class MotivationsController : Controller
    {
        ...
        {
            return View(await _context.Motivations.ToListAsync());
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DateTime,MotivationText,ApplicationUserId")] Motivation motivation)
        {
            if (id != motivation.Id)
            {
                return NotFound();
